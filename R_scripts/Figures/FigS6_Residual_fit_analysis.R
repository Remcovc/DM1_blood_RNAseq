...
load("Z:/Analysis_projects/DvA_recognition_rnaseq_diff_expr/for_paper_counts/CTG_res_CR_fit_values.RDATA")
...
ggsave(plot, 
       file ="Z:/Analysis_projects/DvA_recognition_rnaseq_diff_expr/Publication_GitHub/Revision updates/Figures/FigS6_CR_residuals.png", 
       height = 8, width = 15, 
       dpi = 1200,
       device="png")
