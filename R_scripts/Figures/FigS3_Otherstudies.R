...
# Last changes applied on 22/09/2022
...
Sznajder_blood <- read.csv(file = "Z:/Analysis_projects/RvC_recognition_rnaseq_diff_expr/for_paper_counts/fits_paper/other_studies/wilcox_DM1_GSE138691_values.csv", sep = ",")
# model values from wilcoxon tests in Expression_analyses_other_papers.rmd
Charlet_heart <- read.csv(file = "Z:/Analysis_projects/RvC_recognition_rnaseq_diff_expr/for_paper_counts/fits_paper/other_studies/wilcox_DM1_003_values.csv", sep = ",")
# model values from wilcoxon tests in Expression_analyses_other_papers.rmd
Otero_brain <- read.csv(file = "Z:/Analysis_projects/RvC_recognition_rnaseq_diff_expr/for_paper_counts/fits_paper/other_studies/wilcox_DM1_041_values.csv", sep = ",")
# Table S5 in Wang et al HMG 2019 (DMseq)
DMseq_MBNLinf <- read_excel("Z:/Knowledge_base/DM_T_007/Kallisto_table_s5_ddy432.xlsx")
# model values from wilcoxon tests in Expression_analyses_other_papers.rmd 
DMseq_tibialis <- read.csv(file = "Z:/Analysis_projects/RvC_recognition_rnaseq_diff_expr/for_paper_counts/fits_paper/other_studies/wilcox_DM1_007_values.csv", sep = ",")
#Table EV10 from signorelli et al 2020  
signorelli_DMDblood <- full_join(read_excel("Z:/Knowledge_base/Spitali_DMD.xlsx", sheet = "1_body_measurements"), read_excel("Z:/Knowledge_base/Spitali_DMD.xlsx", sheet = "2_physical_tests"), by = "genes") 
...
ggsave(study_plots, 
       file = "Z:/Analysis_projects/DvA_recognition_rnaseq_diff_expr/Publication_GitHub/Revision updates/Figures/FigS3_Otherstudies.png", 
       height = 15, width = 10, 
       dpi = 1200,
       device="png")
