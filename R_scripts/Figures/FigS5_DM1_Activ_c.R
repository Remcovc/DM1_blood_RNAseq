...
load("Z:/Analysis_projects/DvA_recognition_rnaseq_diff_expr/for_paper_counts/outcome_coef.RDATA")
...
ggsave(plot, 
       file ="Z:/Analysis_projects/DvA_recognition_rnaseq_diff_expr/Publication_GitHub/Revision updates/Figures/FigS5_DM1ActivC.png", 
       height = 12, width = 12, 
       dpi = 1200,
       device="png")
